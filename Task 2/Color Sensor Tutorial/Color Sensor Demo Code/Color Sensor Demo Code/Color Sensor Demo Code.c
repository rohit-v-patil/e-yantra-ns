...
#define F_CPU 14745600UL//define F_CPU value
#include <avr/io.h>
	 ...
	 /* if(red < black_color_threshold && green < black_color_threshold && blue < black_color_threshold)
	  {
		...
		PORTB &= 0xF0; //glow white color on led by making PH4, PH5 and PH6 low
		lcd_print(1,1,1,1);
	  ...
	  else
	  {
		  ...
		  if(red > green && red > blue)
		  {
			//red-PH4;
			PORTB |= 0x0F;	//first making all bits high to turn off led
			PORTB &= 0xFD;	//making PH4 low for red color diode
			lcd_print(1,1,2,1);
		  }
		  ...
		  else if(green > blue && green > red)
		  {
			//green-PH5;
			PORTB |= 0x0F;	//first making all bits high to turn off led
			PORTB &= 0xF7;	//making PH5 low for green color diode
			lcd_print(1,1,3,1);
		  }
		  ...
		  else if(blue > red && blue > green)
		  {
			//blue-PH6;
			PORTB |= 0x0F;	//first making all bits high to turn off led
			PORTB &= 0xFB;	//making PH4 low for blue color diode
			lcd_print(1,1,4,1);
		  }
	  }*/
	}	  
